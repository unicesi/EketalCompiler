...
import co.edu.icesi.eketal.ui.wizard.EketalProjectCreator;
...
public abstract class AbstractEketalUiModule extends DefaultJbaseUiModule {
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Eketal Compare");
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.projectWizard.SimpleProjectWizardFragment2
	public Class<? extends IProjectCreator> bindIProjectCreator() {
		return EketalProjectCreator.class;
	}
